...
const names11 = ["Explorer 1", "Explorer 2", "Explorer 3", "Explorer 4", 1, 2]

const areAllStr = names10.every(name => typeof name === "string") // every
console.log("Ejemplo 10: Son todos los nombres string: " + areAllStr)


const areNotAllStr = names11.every(name => typeof name === "string")
console.log("Ejemplo 10: No todos los nombres son string: " + areNotAllStr)